...
import { emailAndPasswordLogin } from '../redux/actions/auth/auth'
        ...
        <Card className='mb-0'>
          <CardBody>
            ...
            <CardTitle tag='h4' className='mb-1'>
              Bienvenido a la pagina del pueblo! 👋
            </CardTitle>
            <CardText className='mb-2'>Por favor inicia session con tu cuenta para comenzar</CardText>
            <Form onSubmit={handleemailLogin} className='auth-login-form mt-2'   >
              <FormGroup>
              ...
              <FormGroup>
                <div className='d-flex justify-content-between'>
                  ...
                  <Link to='/pages/forgot-password-v1'>
                    <small>Olvide Password?</small>
                  </Link>
                </div>
                <InputPasswordToggle onChange={handleChange}
              ...
              <Button.Ripple onClick={handleemailLogin} color='success' block>
                <User size={20} />    Iniciar Sesion
              </Button.Ripple>
            </Form>
            ...
            <div className='divider my-2'>
              <div className='divider-text'>registrarse con</div>
            </div>
